...
#define ARM_V_ANGLE_ORIGIN          0.08    // [rad] Angle vertical de repos, pour les déplacements
#define ARM_V_ANGLE_STORAGE_UP      0.38    // [rad] Angle vertical permettant la prise et la dépose dans la zone de stockage interne
#define ARM_V_ANGLE_STORAGE_DOWN    0.28    // [rad] Angle vertical permettant la prise et la dépose dans la zone de stockage interne
#define ARM_V_ANGLE_STAGE_0_UP      -0.07   // [rad] Angle vertical de prise/dépose de cube sur le sol
