...
Command(0x9B, "Speed constants",        CommandType.SHORT_ORDER, [Field("Kp", float), Field("Ki", float), Field("Kd", float)], []),
Command(0x9C, "Translation constants",  CommandType.SHORT_ORDER, [Field("Kp", float), Field("Kd", float)], []),
Command(0x9D, "Trajectory constants",   CommandType.SHORT_ORDER, [Field("K1", float), Field("K2", float)], []),
Command(0x9E, "Blocking constants",     CommandType.SHORT_ORDER, [Field("Sensibility", float), Field("Response-time", int)], []),
Command(0x9F, "Stopping constants",     CommandType.SHORT_ORDER, [Field("Epsilon", float), Field("Response-time", int)], []),
