...
Command(0x24, "Arm go home",        CommandType.LONG_ORDER, [], [Field("Arm status", int)]),
...
Command(0x28, "Store cube on top",  CommandType.LONG_ORDER, [], [Field("Arm status", int)]),
Command(0x29, "Take from storage",  CommandType.LONG_ORDER, [], [Field("Arm status", int)]),
