...
Command(0x06, "Aim trajectory", CommandType.SUBSCRIPTION_SCATTER_DATA, [Field("Subscribe", Enum, ["No", "Yes"])],
        [InfoField(TIMESTAMP_INFO_FIELD),
         InfoField("Aim trajectory X", QColor(255, 255, 255), description="mm"),
         InfoField("Aim trajectory Y", QColor(255, 255, 255), description="mm")], outputInfoFrame=True),
...
Command(0x9D, "Translation tunings",    CommandType.SHORT_ORDER, [Field("Kp", float), Field("Kd", float)], []),
